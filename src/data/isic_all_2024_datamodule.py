...
from src.data.components.isic_all_2024_dataset import ISIC2024Dataset
        ...
        if stage in ["fit", "validate", "test"]:
            if not self.data_train and not self.data_val and not self.data_test:
                self.data_train = ISIC2024Dataset(
                    ...
                    "train",
                    self.hparams.df_name,
                    self.hparams.hdf5_name,
                    ...
                    match_histograms=self.hparams.match_histograms,
                )
