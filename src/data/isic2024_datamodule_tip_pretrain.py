...
from src.data.components.isic2024_dataset_tip_pretrain import ISIC2024Dataset
        ...
        if stage in ["fit", "validate", "test"]:
            if not self.data_train and not self.data_val and not self.data_test:
                self.data_train = ISIC2024Dataset(
                    ...
                    transforms_default=self.transforms_test,
                    transforms_type=self.transforms_type,
                    replace_special_rate=self.hparams.replace_special_rate,
